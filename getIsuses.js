...
const newIssues = `https://github.com/${owner}/${repo}/issues/new`
const filePath = `./docs/${repo}`
...
function generateIssueMarkdown(issue) {
  ...
  fs.writeFile(`${filePath}/${issue.number}.md`, content, 'utf8').then(() =>
...
`
  ...
  fs.writeFile(`${filePath}/index.md`, content, 'utf8').then(() =>
  ...
  fs.writeJSON('./docs/daily-notes.json', jsonContent, {
    spaces: 2,
    encoding: 'utf8'
